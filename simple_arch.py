...
N_TRAIN_IMG = BATCH_SIZE * 1093
N_TEST_IMG = BATCH_SIZE * 1
N_MUSTACHE_IMG = BATCH_SIZE * 121
N_NO_MUSTACHE_TRAIN_IMG = BATCH_SIZE * 121
N_NO_MUSTACHE_TEST_IMG = BATCH_SIZE * 1
